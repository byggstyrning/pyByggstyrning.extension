...
If elements are selected: Sets the MMI parameter value to 225 on selected elements.
If no selection: Selects all elements with MMI value 225.

Shift-Click: Selects all elements with MMI value 225.
...
if is_shift or not selection or not selection.element_ids:
    ...
    select_elements_by_mmi(revit.doc, revit.uidoc, "225")
else:
